...
namespace ECommerce1.Migrations
{
    ...
    [Migration("20260818200532_AddReturnRequestIdToInventoryTransaction")]
    partial class AddReturnRequestIdToInventoryTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.CampaignAddonProductRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CampaignAddonProductRules");
                });

            modelBuilder.Entity("ECommerce.Models.CampaignMainProductRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CampaignMainProductRules");
                });
            ...
            modelBuilder.Entity("ECommerce.Models.CartItem", b =>
                {
                    ...
                    b.Property<int?>("ParentCartItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.Category", b =>
                {
                    ...
                    b.Property<string>("SpecsTemplate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ECommerce.Models.CategoryBrandDefault", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DefaultSpecs")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ECommerce.Models.CustomerDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("AddonDiscountAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ECommerce.Models.OrderItem", b =>
                {
                    ...
                    b.Property<decimal>("CostPriceAtPurchase")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ECommerce.Models.ProductVariant", b =>
                {
                    ...
                    b.Property<string>("SpecsOverride")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ECommerce.Models.PromotionCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.ReturnRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.WarrantyPackageRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WarrantyPackageRules");
                });
            ...
            modelBuilder.Entity("ECommerce1.Models.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECommerce.Models.CampaignAddonProductRule", b =>
                {
                    ...
                    b.HasOne("ECommerce.Models.PromotionCampaign", "Campaign")
                        .WithMany("AddonProductRules")
            ...
            modelBuilder.Entity("ECommerce.Models.CartItem", b =>
                {
                    b.HasOne("ECommerce.Models.PromotionCampaign", "AppliedCampaign")
                        .WithMany()
                        .HasForeignKey("AppliedCampaignId");
                    ...
                    b.HasOne("ECommerce.Models.CartItem", "ParentCartItem")
                        .WithMany()
                    ...
                    b.HasOne("ECommerce.Models.Warranty", "Warranty")
                        .WithMany()
                        .HasForeignKey("WarrantyId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AppliedCampaign");
            ...
            modelBuilder.Entity("ECommerce.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("ECommerce.Models.CustomerDevice", "CustomerDevice")
                        .WithMany()
                    ...
                    b.HasOne("ECommerce.Models.OrderItem", "ParentOrderItem")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Models.ReturnItem", b =>
                {
                    ...
                    b.HasOne("ECommerce.Models.ReturnRequest", "ReturnRequest")
            ...
            modelBuilder.Entity("ECommerce.Models.PromotionCampaign", b =>
                {
                    b.Navigation("AddonProductRules");

                    b.Navigation("MainProductRules");
                });
