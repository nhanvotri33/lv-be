...
namespace ECommerce1.Migrations
{
    ...
    [Migration("20260717153616_AddVariantIdToInventoryDetail")]
    partial class AddVariantIdToInventoryDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Models.ProductCombo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.ProductComboItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductComboId", "ProductId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ECommerce.Models.CartItem", b =>
                {
                    b.HasOne("ECommerce.Models.ProductCombo", "AppliedCombo")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Models.ProductComboItem", b =>
                {
                    b.HasOne("ECommerce.Models.ProductCombo", "ProductCombo")
                        .WithMany("ComboItems")
