...
fs.writeFileSync('c:/source/nhan-lv/lv-be/ECommerce1/SampleData/seed_warranties.sql', sql, 'utf8');
console.log("Đã tạo seed_warranties.sql thành công!");
